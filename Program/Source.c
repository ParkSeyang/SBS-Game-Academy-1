...
#pragma region 배열
	...
	// printf("float 자료형의 크기 : %u\n", sizeof(float));
	 
	// printf("array 배열의 크기 : %u\n", sizeof(array));
	...
	// printf("변경된 list[2] 의 값 = %f\n", list[2]);
	// printf("pointer 의 값 = %p\n", pointer);
...
#pragma region 문자열
	...
	// 가리키도록 할 수 있으며, 문자열 상수는 데이터 영역의 읽기 전용 
	// 공간에 저장되기 때문에 문자열 의 값을 변경할 수 없습니다.
	...
	// printf("word 배열의 값 : %s\n", word);
	//
	// word = content; // (X) 값을 덮어씌우기가 안되기때문에 오류가남
